...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GatewayIstioSpec) DeepCopyInto(out *GatewayIstioSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GatewayIstioSpec.
func (in *GatewayIstioSpec) DeepCopy() *GatewayIstioSpec {
	if in == nil {
		return nil
	}
	out := new(GatewayIstioSpec)
	in.DeepCopyInto(out)
	return out
}
